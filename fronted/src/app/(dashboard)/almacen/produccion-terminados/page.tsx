...
import { Plus, Check, Search, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function ProduccionTerminadosPage() {
  ...
  // Filtrado
  const baseProducciones = producciones.filter(prod => prod.outputs.some((out: any) => out.product?.warehouseId === terminados[0]?.warehouseId || out.product?.warehouse?.name === "Productos Terminados"));
